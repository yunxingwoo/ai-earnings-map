...
- 半年度:`YYYYHn`(如 `2026H1`),**仅用于无季度披露的半年报公司**(现例:港股 02513 智谱 / 0100 MiniMax)。同比=与上年同期半年度比较(`js/calc.js` yoyAt 已支持);序列不足 3 期信号灯保持 ⚪;半年度公司**不进入**首页"最新已披露季"求和(render-home.js 的 withDataQ 过滤),避免 H1 累计混入季度口径。
